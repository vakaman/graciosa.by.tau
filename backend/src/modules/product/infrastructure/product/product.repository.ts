...
export class ProductRepository implements ProductRepositoryInterface {
  ...
  async findByIdWithVariants(id: number): Promise<Product | null> {
  ...
  async saveVariant(productId: number, variant: ProductVariant): Promise<void> {
    await this.prisma.productVariant.create({
      data: {
        productId,
        color: variant.color,
        size: variant.size,
        price: variant.price.toCents(),
        sku: variant.sku,
